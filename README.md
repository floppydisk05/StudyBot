# StudyBot
StudyBot is a Discord bot designed specifically for use in the [WinWorld Discord server](https://discord.gg/HepVSYH).

## Usage/Build instructions
1. Clone the repository: ``https://github.com/Starman0620/StudyBot.git`` and move into the project directory: ``cd StudyBot``
