    ...
    public class EvalCommand : BaseCommandModule
    {
        ...
        public async Task Kill(CommandContext Context, [RemainingText]string code)
        {
            ...
            try
            {
                ...
                {
                    if (!assembly.IsDynamic && assembly.FullName.ToLower().Contains("dsharp") || assembly.FullName.ToLower().Contains("newtonsoft") || assembly.FullName.ToLower().Contains("microsoft.csharp") || assembly.FullName.ToLower().Contains("studybot") || assembly.FullName.ToLower().Contains("scottplot"))
                    {
...
using StudyBot;
using StudyBot.Commands.Attributes;" + code;
